# Twin of control/ft_servo_python_only.py (the CANONICAL copy). Byte-identical to
# it below this header since 2026-08-22, when the sign-magnitude encoding of
# negative positions in set_position was ported here. Fix the canonical copy
# first, then mirror it here. Importer: change_id.py. See ../README.md.
"""
