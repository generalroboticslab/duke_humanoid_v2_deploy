# CANONICAL copy. Twin: hardware_bindings/common/publisher.py, byte-identical to
# this file below the header comments since 2026-08-22 (strict_map_key=False on
# both msgpack.unpackb calls was ported there). Fix here first, then mirror it.
import socket
import urllib.parse
import threading
import time
